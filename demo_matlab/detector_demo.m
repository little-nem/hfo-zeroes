% Load the segment we will analyze
...
for time = event_list(2:end)
    ...
    % Find local minima, using find_zeros.oct(_mex.mex)
    ...
    % Use find_components_mex.mex to compute components and their caracteristics
    % Remember that find_components_mex only needs the first three lines of our
